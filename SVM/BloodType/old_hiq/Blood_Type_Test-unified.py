...
plt.title("Totals for each blood type")
plt.savefig("Blood_type_totals.png")
del huids_df
...
for bloodtype in ['A', 'B']:
	...
	print("Accuracy LOO: %0.2f (+/- %0.2f)" % (scoresLOO.mean(), 
              scoresLOO.std() * 2))
	...
	classes = [bloodtype + '-antigen negative',bloodtype + '-antigen positive']
	...
	plt.savefig(bloodtype + "_Confusion.png", format='png',dpi=300)
