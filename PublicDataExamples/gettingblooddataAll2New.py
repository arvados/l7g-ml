...
np.save('ycheck2.npy', y)
np.save('Xtraincheck2.npy', tiledata[:,10000])
np.save('oldpathcheck2.npy', oldpath)
np.save('varvalscheck2.npy', varvals)
np.save('pathdataOHcheck2.npy', pathdataOH)
