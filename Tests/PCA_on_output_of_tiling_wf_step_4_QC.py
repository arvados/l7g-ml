...
# I/O directories and paths
data_1hot_dir = "/home/keldin/rwkeep/by_id/su92l-4zz18-t8e4leto2uhtxqu/"
data_1hot_path = data_1hot_dir + "npy-hiq/hiq-1hot"
plot_output_dir = "/home/keldin/rwkeep/by_id/su92l-4zz18-hhyjc7arp04d20t/"

# Load data
data_1hot = np.load(data_1hot_path)
...
# Save figure
plt.savefig(plot_output_dir + "PCA_QC_on_tiling_wf.png", format='png',dpi=300)
